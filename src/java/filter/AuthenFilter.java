...
public class AuthenFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            System.out.println("CHECK URI: " + rq.getRequestURI());

            // If the user doesn't login
            if (acc == null) {
                request.setAttribute("error", "ERROR: You must login first.");
                request.getRequestDispatcher("/login_green.jsp").forward(request, response);
            }
